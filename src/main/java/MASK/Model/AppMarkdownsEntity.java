...
@Entity
@Table(name = "app_markdowns", schema = "mask", catalog = "")
public class AppMarkdownsEntity {
    private int appmarkdownId;
    ...
    @Id
    @Column(name = "appmarkdown_id")
    public int getAppmarkdownId() {
        return appmarkdownId;
    }

    public void setAppmarkdownId(int appmarkdownId) {
        this.appmarkdownId = appmarkdownId;
    }
    ...
    public boolean equals(Object o) {
        ...
        AppMarkdownsEntity that = (AppMarkdownsEntity) o;

        if (appmarkdownId != that.appmarkdownId) return false;
